...
public class ScheduleRecord {
    ...
    // Constructor chính
    public ScheduleRecord(String id, String subject, String time, String location, Long groupId) {
        this.id = id;
    ...
    // Constructor đầy đủ (có cả chatTitle)
    public ScheduleRecord(String id, String subject, String time, String location, Long groupId, String chatTitle) {
        this(id, subject, time, location, groupId);
    ...
    public Set<Long> getConfirmedUsers() { return confirmedUsers; }
